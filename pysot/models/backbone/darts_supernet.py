...
class SuperNet(nn.Module):
  ...
  def forward(self, x):
    ...
    cell: 3 torch.Size([b, 192, 64, 64]) False
    cell: 4 torch.Size([b, 384, 32, 32]) True
    ...
    cell: 10 torch.Size([b, 384, 32, 32]) False
    cell: 11 torch.Size([b, 384, 32, 32]) False
    cell: 12 torch.Size([b, 384, 32, 32]) False
    cell: 13 torch.Size([b, 384, 32, 32]) False
    :param x:
    :return:
    """
    # print('in:', x.shape)
...
def darts_supernet(**kwargs):
    """Constructs a Darts_supernet model.
